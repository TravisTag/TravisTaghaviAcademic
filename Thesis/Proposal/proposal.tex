...
\renewcommand{\tamupapertype}{Proposal}
...
\renewcommand{\tamumemberone}{Jean-Francois Chamberland}
\newcommand{\tamumembertwo}{Gregory Huff}
\newcommand{\tamumemberthree}{Krishna Narayanan}
\newcommand{\tamumemberfour}{Dylan Shell}
\renewcommand{\tamudepthead}{Jose Antonio Silva}

%Type only May, August, or December.
\renewcommand{\tamugradmonth}{May}
\renewcommand{\tamugradyear}{2017}
%Your department name goes here.
\renewcommand{\tamudepartment}{Electrical and Computer Engineering}
