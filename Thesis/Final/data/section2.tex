...
The data selection yielded four large datsets, totaling 8768 images.
...
Where $f_{i, j}$ is the mass moved between bin $i$ and $j$ in the two discrete distributions, and $d_{i, j}$ is the distance between bins $i$ and $j$.
